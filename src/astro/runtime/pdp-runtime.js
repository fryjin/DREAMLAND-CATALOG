(function(root){
  ...
  function renderConfigurationProjection(view){
    ...
    quantitySection.className=
      'pdp-config-projection pdp-config-projection--quantity';

    quantitySection.dataset
      .pdpProjectionField=
      'quantity';
