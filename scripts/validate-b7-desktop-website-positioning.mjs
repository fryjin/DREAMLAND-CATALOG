...
try{
  ...
  requireIncludes(
    ...
    [
      ...
      './images/desktop/home/hero/hero-main.webp?release=b7-00b3b-r1-v96',
...
console.log(
  'Website positioning / no Desktop→Mobile boot fallback / Desktop marketing media fast path / no duplicate Home asset render / PWA v96 PASS.'
);
