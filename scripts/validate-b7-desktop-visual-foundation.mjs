...
try{
  ...
  const tokensRef='./src/ui/desktop/styles/tokens.css?release=b7-00b4d-r1.5.1-v116';
  const primitivesRef='./src/ui/desktop/styles/primitives.css?release=b7-00b4d-r1.5.1-v116';
  const shellRef='./src/ui/desktop/styles/shell.css?release=b7-00b4d-r1.5.1-v116';
