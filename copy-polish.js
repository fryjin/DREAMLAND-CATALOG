(function(){
  ...
  const UI_PATCH={
    zh:{
      ...
      successTitle:'询价已提交',
      successSub1:'我们已收到您的询价。',
      successSub2:'我们会联系您确认需求和报价。',
      statusPending:'待联系',
      estimatedAmount:'参考金额',

      updatedInquiry:'商品信息已更新',
      removedInquiry:'已从询价单移除',
      emptyInquiry:'请先添加产品或定制项目',
      needInquiryFirst:'请先添加产品或定制项目',
      ...
      submissionArchived:'询价已提交，当前内容已清空。',
      archiveStatus:'已提交',
      captchaLabel:'安全验证',
      ...
      processTitle:'提交说明',
      processNote:'提交询价不会直接生成订单。我们会联系您确认需求、报价和后续安排。'
    },
    en:{
      ...
      inquirySub:'Review inquiry items and estimated product amount',
      emptyTitle:'No items in this inquiry',
      emptyText:'Choose products or add a custom request.',
      makeCustom:'Add Custom Request',
      inquiryContent:'Inquiry Items',
      ...
      clearConfirmTitle:'Clear this inquiry?',
      clearConfirmText:'All products and custom projects will be removed.',
      cancel:'Keep Items',
      ...
      successSub1:'We have received your inquiry.',
      ...
      processNote:'Submitting an inquiry does not place an order. We will contact you to confirm requirements, pricing and next steps.'
    },
    ko:{
      docTitle:'DREAMLAND | 핸드카빙 캔들 도매 · 커스텀',
      catalogTitle:'제품 카탈로그',
      catalogSub:'제품을 선택한 뒤 견적을 확인하세요',
      detailTitle:'옵션 선택',
      ...
      inquiryTitle:'문의 목록',
      inquirySub:'문의 내용과 예상 금액을 확인하세요',
      emptyTitle:'문의에 추가된 항목이 없습니다',
      emptyText:'제품을 선택하거나 커스텀 요청을 작성하세요.',
      makeCustom:'맞춤 제작 요청 작성',
      inquiryContent:'선택한 내용',
      productEstimate:'상품 예상 금액',
      summaryNote:'표시 금액은 참고용입니다. 실제 가격은 확인된 견적을 기준으로 확정됩니다.',
      consultantQuote:'요청 사항 확인 후 견적을 안내드립니다',
      consultantConfirm:'요청 사항 확인 후 견적을 안내드립니다',
      clearConfirmTitle:'문의 내용을 모두 삭제할까요?',
      clearConfirmText:'문의에 추가된 제품과 커스텀 요청이 모두 삭제됩니다.',
      cancel:'그대로 두기',

      contactTitle:'연락처',
      contactSub:'요청 사항과 견적 확인을 위해 연락드립니다',
      nameLabel:'담당자 *',
      messageLabel:'기타 안내',
